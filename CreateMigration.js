...
// IMPORTANTE: Utilizar este script unicamente para crear (no generar) migrations vacias
// Para generar migrations utilizar el comando "npm run typeorm:local migration:generate ./src/Migrations/<nombre-migration>"
